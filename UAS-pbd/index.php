    ...
    <nav class="navbar navbar-expand-lg" style="background-color: #3f51b5">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                <a class="nav-link" aria-current="page" href="view/dashboard.php">Dashboard</a>
                </li>
                <li class="nav-item">
                <a class="nav-link" aria-current="page" href="view/pengajar.php">Staff Pengajar</a>
                </li>
                <li class="nav-item">
                <a class="nav-link" aria-current="page" href="view/administrasi.php">Staff Administrasi</a>
                </li>
                <li class="nav-item">
                <a class="nav-link" aria-current="page" href="view/teknisi.php">Staff Teknisi</a>
                </li>
            </ul>
